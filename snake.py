...
def write_train_data(filename, content):
...
while True:
    ...
    movement = find_movement(direction, change_to)
    ...
    if snake_pos[0] < 0 or snake_pos[0] > frame_size_x - 10:
        ...
        write_train_data("train_x_data.json",
                         [find_blockage(snake_body[0], snake_body[1])[0],
                          find_blockage(snake_body[0], snake_body[1])[1],
                          find_blockage(snake_body[0], snake_body[1])[2], angle_with_apple(snake_body, food_pos),
                          snake_condition])
        write_train_data("train_y_data.json", movement)
        # print_condition('term\n-1')
        game_over()
    ...
    # snake_condition = 0  # snake is alive but not get any score
    # print(snake_body,'\t',food_pos)
    # print(snake_condition)
    write_train_data("train_x_data.json",
                     [find_blockage(snake_body[0], snake_body[1])[0],find_blockage(snake_body[0], snake_body[1])[1],
                      find_blockage(snake_body[0], snake_body[1])[2],angle_with_apple(snake_body, food_pos),
                      snake_condition])
    write_train_data("train_y_data.json", movement)
